...
YEAR = 2027
raw = json.load(open(ROOT / "_qs_raw.json", encoding="utf-8"))
items = []
for r in raw:
...
write_json(ROOT / "frontend" / "public" / "data" / "rankings" / "qs.json", items)
print("QS assembled:", len(items), "rows, year", YEAR)
